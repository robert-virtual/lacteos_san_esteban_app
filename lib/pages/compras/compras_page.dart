  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() => StreamBuilder(
            stream: comprasCollection
                .where("proveedor", isEqualTo: rxProveedor.value)
                  ...
                  SliverAppBar(
                    ...
                    actions: [
                      Wrap(
                        ...
                        children: [
                          Visibility(
                            visible: rxProveedor.value != null,
                            child: ChoiceChip(
                              label: Row(
                                children: [
                                  Text(
                                    rxProveedor.value != null
                                        ? rxProveedor.value!.id.substring(0, 10)
                                        : "Proveedor",
                                  ),
                                  const Icon(Icons.close)
                                ],
                              ),
                              selected: rxProveedor.value != null,
                              onSelected: (value) {
                                print("value: $value");
                                if (!value) {
                                  rxProveedor.value = null;
